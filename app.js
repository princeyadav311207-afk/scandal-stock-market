(function () {
    ...
    return `
      <section class="grid" style="margin-top:18px">
        ...
        <div class="grid three">
          ...
          <div class="metric"><span>Winner Share</span><strong>${currency(round.payoutPerWinner)}</strong></div>
        </div>
        ${round.winningBettorCount > 0 ? `<p class="notice">Winning bets return the original wager plus the winner share from the losing pool.</p>` : ""}
  ...
  function betTable(round) {
    ...
    return `
      <table class="table">
        <thead><tr><th>Bettor</th><th>Bet</th><th>Target</th><th>Type</th><th>Result</th><th>Returned</th></tr></thead>
